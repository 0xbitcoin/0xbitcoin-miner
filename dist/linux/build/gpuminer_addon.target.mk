...
cmd_binding_gyp_gpuminer_addon_target_cuda_on_linux_0 = LD_LIBRARY_PATH=$(builddir)/lib.host:$(builddir)/lib.target:$$LD_LIBRARY_PATH; export LD_LIBRARY_PATH; cd $(srcdir)/.; mkdir -p $(obj).$(TOOLSET)/gpuminer_addon/geni; nvcc -ccbin clang-3.8 -Xcompiler -fpic -c -o "$(obj).$(TOOLSET)/gpuminer_addon/geni/cuda_sha256d.o" "$(abspath $<)"
...
$(obj).target/gpuminer_addon.node: $(OBJS) $(obj).$(TOOLSET)/$(TARGET)/geni/cuda_sha256d.o FORCE_DO_CMD
