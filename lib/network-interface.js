...
module.exports =  {
  ...
  try{
   ...
   var addressTo = this.tokenContract.options.address;
    ...
    var gas_price_wei = self.gas_price_gwei * gweiToWei;
    var max_gas_cost = 1704624;

    var privateKey = self.miner_private_key;
  ...
  async sendSignedRawTransaction(web3,txOptions,addressFrom, privateKey ,callback) {


    var fullPrivKey = privateKey;
