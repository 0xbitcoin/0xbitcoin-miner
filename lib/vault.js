...
module.exports =  {
    ...
    handleCommand(subsystem_command,subsystem_option)
    {
      ...
      if(subsystem_command === 'select' || subsystem_command === 'account')
      {
        this.selectAccount(subsystem_option);
        this.saveVaultData( vaultData );
      }

      if(subsystem_command === 'contract')
      {
    ...
    getAccount()
    {
      ...
      if( typeof vaultData.selected_account_address == null ) //check for null or undefined
      {
