...
module.exports =  {
    ...
    {
      var int_gprice = parseInt(gprice);

      if(int_gprice > 1 && int_gprice < 100000)
      {
          vaultData.mining_gas_price = gprice;
          console.log('Set gas price (gwei): ', gprice);
      }

      if(int_gprice > 100)
      {
        console.log('WARNING: Extremely high gas price (gwei) detected - use something smaller?: ', gprice);
      }
    ...
    getInitialVaultDataJson()
    {
      var datastore = {
        ...
        "account_list": [],
        "mining_gas_price": 2,
        "web3_provider_url": INFURA_ROPSTEN_URL,
