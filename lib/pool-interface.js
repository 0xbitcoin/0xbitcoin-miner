  ...
  getMinimumShareDifficulty()
  {
    ...
    async queryPoolConfig()
    {
      ...
      var poolEthAddress = await new Promise(function (fulfilled,rejected) {
           ...
           this.jsonrpcClient.request('getPoolEthAddress', args, function(err, response) {
              if(err) rejected(err);
      ...
      var poolMinimumShareDifficulty = await new Promise(function (fulfilled,rejected) {
           ...
           this.jsonrpcClient.request('getMinimumShareDifficulty', args, function(err, response) {
              if(err) rejected(err);
              fulfilled(response.result)
            });
      ...
      //  console.log('poolEthAddress',poolEthAddress)
    },
