...
module.exports =  {
  ...
  //  setInterval(function(){ this.pollStartMining()}.bind(this), 500)
...
*/
  ...
  /*  pollStartMining()
  {
    console.log(' poll start mining ', this.receivedPoolConfig)
    if(startedMining == false && this.receivedPoolConfig == true)
    {
      startedMining = true;
      console.log('starting mining for pool')
        Miner.mineForPool(this.poolEthAddress,minerConfig.pool_url)
...
*/
    ...
    queueMiningSolution(addressFrom,minerEthAddress,solution_number,challenge_digest, challenge_number, target, difficulty )
 {
  ...
  async submitMiningSolution(addressFrom,minerEthAddress, solution_number,challenge_number, challenge_digest, target, difficulty){
       ...
       console.log('sha3inputs ', [challenge_number , minerEthAddress, solution_number ])
       var computed_digest =  web3Utils.soliditySha3( challenge_number , minerEthAddress, solution_number )
