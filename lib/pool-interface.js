...
*/
  ...
  async sendMiningSolutions()
        ...
        if(queuedMiningSolutions.length > 0)
        {
          ...
          if( nextSolution.challenge_number != lastSubmittedMiningSolutionChallengeNumber)
          {
            ...
            var response = await this.submitMiningSolution(nextSolution.addressFrom,
              nextSolution.solution_number, nextSolution.challenge_digest, nextSolution.target, nextSolution.difficulty);
            }catch(e)
            {
    ...
    queueMiningSolution(addressFrom,solution_number,challenge_digest, challenge_number, target, difficulty )
 {
  ...
  async submitMiningSolution(addressFrom,solution_number,challenge_digest, target, difficulty){
